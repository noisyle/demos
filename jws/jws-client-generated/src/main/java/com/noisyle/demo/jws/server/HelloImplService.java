 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://server.jws.demo.noisyle.com/", wsdlLocation = "http://localhost:8080/jws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://server.jws.demo.noisyle.com/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jws/hello?wsdl");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://server.jws.demo.noisyle.com/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jws.demo.noisyle.com/", "HelloImplPort"), Hello.class, features);
    }
